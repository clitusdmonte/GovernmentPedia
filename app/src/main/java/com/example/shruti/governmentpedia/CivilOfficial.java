...
public class CivilOfficial implements Serializable{
    ...
    /**************************************************
     *constrctor with all params
     * @param officialName
     * @param officialAddress
     * @param officialParty
     * @param officialPhNumList
     * @param officialEmailList
     * @param officialWebsiteList
     * @param officialPhotoLink
    ...
    /************************************
     *
     * @return email list of officials
     */
