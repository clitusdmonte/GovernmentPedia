...
public class CivilGovermentAdaptor extends RecyclerView.Adapter<CivilGovermentViewHolder> {
     ...
     * Public method
     * @param mainActivity
     * @param civilGovermentOfficialList
     */
     ...
     * @param parent
     * @param viewType
     * @return display officials list in Item view
     */
    ...
    /*********************************************************
     * Adds Officials name and party to the holder
     * @param holder containing officials Name and name of party
     * @param position
     */
