...
public class MainActivity extends AppCompatActivity implements DownloadCallback<String>,View.OnClickListener {
    ...
    final String APT_KEY = "AIzaSyAPApbnFEHypEDmfhEjp-HfEnV2Mst9Ac0";
    ...
    /************************************************
     * setting content into the layout by fetching data
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showUserAlert("Alert", "Please make sure you have active Internet Connection \n and Location Service.");
    ...
    /***************************************************
     *
     * @param result which local address of the officials
     */
    @Override
    ...
    /***********************************************************
     * Search dialog box appear when user click on search icon
     * User should enter city or state or zip code
     */
    ...
    public void onClick(View view) {
        ...
        Log.d(TAG,"Goverment officie selected => "+ civilGovermentOfficial.getOfficeName());
        startOfficialActivity(ACT_SHOW,pos);
    }

    /********************************************************
     * Get the list from layout to append data - recycler view
     * Uses civil government adapter to fetch data
     *
     */
    ...
    /**************************************************
     * Getting lat long from the address
     * @param latitude
     * @param longitude
     * @return
     */
    ...
    /*****************************************
     * Getting permission to fetch the result
     * @param lat
     * @param lon
     */
